...
# ── ЗЕТ (зачётные единицы трудоёмкости, ФГОС) — docs/done/PLAN-ZET.md ────────────────────
...
def subject_zet_state(lessons, records, zet, term_over: bool, scale: str = "5"):
    """Состояние предмета по ЗЕТ: "passed" | "pending" | "failed" | None (docs/done/PLAN-ZET.md §2).
...
def zet_summary(subject_rows) -> dict:
    ...
    задан» показывать нигде нельзя (docs/done/PLAN-ZET.md §10).

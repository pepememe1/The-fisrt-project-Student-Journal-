...
<template>
  ...
  <div class="flex h-full overflow-hidden">
    <!-- Десктоп: постоянный сайдбар.
         ...
         жила, грузила профиль, спрашивала статус и вела слежение за бездействием — а при
         открытии мобильной шторки рядом появлялся ВТОРОЙ такой же экземпляр, со своими
         запросами и своими таймерами. Невидимая работа вдвойне обидна на телефоне: её
         не видно ни на экране, ни в отладке — только в расходе батареи. -->
    <div v-if="!embed && isLg" class="hidden lg:block">
      <Sidebar />
    </div>
    ...
    <!-- Активности (docs/done/PLAN-ACTIVITIES.md §10). ⚠️ РЯДОМ с <RouterView>, а НЕ внутри
